...
<div class="container">
  ...
  <!-- Full-width images with number text -->
      <div class="bigImg">
            <?php $loop = new WP_Query((array('post_type' => 'realisation','order'=>'DSC', 'posts_per_page'=>1)));
  ...
  <div class="gallerie">
      <?php $loop = new WP_Query((array('post_type' => 'realisation','order'=>'DSC', 'posts_per_page'=>50)));
      while ( $loop->have_posts() ) : $loop->the_post(); ?>
